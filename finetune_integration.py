...
adata.obs["celltype"] = adata.obs["sample"].astype("category")
...
(
    ...
    celltypes_labels,  # The cell type labels for stratification
    test_size=0.2,  # 20% of the data for validation
    shuffle=True,
    stratify=celltypes_labels  # Ensure stratification by cell type labels
)
