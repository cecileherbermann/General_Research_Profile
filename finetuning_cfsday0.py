...
# Path settings
adata = sc.read_h5ad(r"C:\Users\jzuyd\Documents\LACDR\PhD\scRNAseq data\scGPT\CFS\dataset_CFS_d0_indi_analysed_light.h5ad")
model_path = r"C:\Users\jzuyd\Documents\LACDR\PhD\scRNAseq data\scGPT\scGPT_human"

# For raw data
# CFS = sc.read_h5ad(r"C:\Users\jzuyd\Documents\LACDR\PhD\scRNAseq data\scGPT\CFS\CFS_all_days_rawcount.h5ad")
...
preprocessor = Preprocessor(
    ...
    filter_gene_by_counts=False,  # 1. Set to False since the input data is already filtered
    filter_cell_by_counts=False,  # 2. Set to False since the input data is already filtered
