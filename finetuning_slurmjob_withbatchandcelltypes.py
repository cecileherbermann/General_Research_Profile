...
# Take arguments from the command line and prepare adata input for scGPT
def main(model_path, raw_data_path, processed_data_path, day):
    # Load data
    raw_data = anndata.read_h5ad(raw_data_path)
    processed_data = anndata.read_h5ad(processed_data_path)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process scRNAseq data with specified day.")
    parser.add_argument('--model_path', required=True, help="Path to the model directory.")
    parser.add_argument('--raw_data_path', required=True, help="Path to the raw CFS dataset.")
    parser.add_argument('--processed_data_path', required=True, help="Path to the filtered dataset.")
    parser.add_argument('--day', required=True, choices=['CFS_Day0', 'CFS_Day2', 'CFS_Day14', 'CFS_Day28'],
                        help="Specify the day to filter the data.")

    args = parser.parse_args()
    main(args.processed_data_path, args.model_path, args.raw_data_path, args.day)
